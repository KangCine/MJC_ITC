...
public class MemberDAO {
  ...
  public int insertMember(MemberVO memberVO) {
    int result = 0;
    String sql = "insert into member(id, pwd, name, email,age, gender, nara, phone) values(?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try {
      ...
      pstmt.setString(5, memberVO.getAge());
      pstmt.setString(6, memberVO.getGender());
      pstmt.setString(7, memberVO.getFrom());
	...
	/* *
	 * �꽴占썹뵳�딆쁽 筌뤴뫀諭띰옙肉됵옙苑� 占쎄텢占쎌뒠占쎈┷占쎈뮉 筌롫뗄�꺖占쎈굡 * *
	 */
